...
namespace NexaMerchant\Shopify\Console\Commands\CustomCollection;
...
use NexaMerchant\Shopify\Models\ShopifyOrder;
...
class Products extends Command
{
    ...
    public function handle()
    {
        ...
        $items = \NexaMerchant\Shopify\Models\ShopifyCustomCollection::select(['collection_id'])->get();
    ...
    protected function getCollectionProduct($collection, $shopify, $client) {
        ...
        foreach($body['products'] as $key=>$product) {
            ...
            $userCollection = \NexaMerchant\Shopify\Models\ShopifyCollectionProduct::where("collection_id", $collection->collection_id)->where("shopify_store_id", $this->shopify_store_id)->where("product_id", $product['id'])->first();
            if(is_null($userCollection)) $userCollection = new \NexaMerchant\Shopify\Models\ShopifyCollectionProduct;
