...
class Get extends Command
{
    ...
    public function handle()
    {
        ...
        foreach($body['custom_collections'] as $key=>$collection) {
            $userCollection = \NexaMerchant\Shopify\Models\ShopifyCustomCollection::where("collection_id", $collection['id'])->first();
            if(is_null($userCollection)) $userCollection = new \NexaMerchant\Shopify\Models\ShopifyCustomCollection;
