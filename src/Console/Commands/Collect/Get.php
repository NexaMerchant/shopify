...
namespace NexaMerchant\Shopify\Console\Commands\Collect;
...
class Get extends Command
{
    ...
    public function syncProductToLocal() {
        $items = \NexaMerchant\Shopify\Models\ShopifyProduct::where("shopify_store_id", $this->shopify_store_id)->get();
